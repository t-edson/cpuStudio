...
type
  ...
  public  //Administración de archivos
    ...
    function CloseAll(out lstClosedFiles: string; out curFile: string): boolean;
...
function TfraEditView.CloseAll(out lstClosedFiles: string;
                               out curFile: string): boolean;
...
Se devuelve en "curFile" el archivo actualmente abierto.}
begin
  lstClosedFiles := '';
